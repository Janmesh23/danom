 ...
 */
export const APP_NAME = 'danom';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'minigames built with monad testnet';
 ...
 */
export const APP_TAGS = ['entertainment', 'fun', 'exciting'];
 ...
 */
export const APP_BUTTON_TEXT = 'Let\'s have funnnn';
